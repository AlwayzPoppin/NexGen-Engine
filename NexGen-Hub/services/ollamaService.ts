...
- __NAV__[MODULE]: Navigate to a module.
- VALID MODULES: ASSEMBLER, GENESIS, SYNAPSE, ECHO, NOVA, ATLAS, AIRLOCK. (DO NOT invent others).
- __CMD__NEW_PROJECT: Open new project wizard.
- __CMD__CLEAR_SESSION: Reset context/assets.
- __DELEGATE_TO_GEMINI__: Use for complex reasoning or lore generation.
`;
